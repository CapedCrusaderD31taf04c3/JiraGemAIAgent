...
class CoderPrompt:
    ...
    A: '{"pr_desc": "## Description\nadd todo_main function\n\n## Changes Made\n- change name of main function to todo_main function\n\n## Checklist\n- [] I have tested these changes locally.\n- [ ] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [ ] I have added unit tests for the new code (if applicable).\n- [ ] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nThis adjustment ensures consistency with naming conventions throughout the codebase.", "commit_msg": "refactor: renamed main to todo_main", "src_code" : [{"file_location": "E:/Dummy_Project/todo_app/src/main.py", "source_code": "from Todo import TodoApp\\n\\ndef todo_main() -> None:\\n    app: TodoApp = TodoApp()\\n    app.start()\\n\\nif __name__ == \\"__main__\\":\\n    todo_main()", "to_update": true}]}'
    Q: {
        "heading": "Add proper documentation in source code",
        "info": "Add descriptive docstrings wherever they are necessary"
    }
    A: '{"pr_desc": "## Description\nAdd proper documentation in source code\n\n## Changes Made\n- Add descriptive docstrings wherever they are necessary\n\n## Checklist\n- [x] I have tested these changes locally.\n- [x] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [ ] I have added unit tests for the new code (if applicable).\n- [ ] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nThis task involves adding clear and concise documentation, such as docstrings, to the relevant code sections.", "commit_msg": "docs: Add descriptive docstrings for improved code documentation", "src_code": [{"file_location": "E:/Dummy_Project/todo_app/src/main.py", "source_code": "from Todo import TodoApp\\n\\ndef todo_main() -> None:\\n    \\"\\"\\" Main Function For ToDo App \\"\\"\\"\\napp: TodoApp = TodoApp()\\n    app.start()\\n\\nif __name__ == \\"__main__\\":\\n    todo_main()", "to_update": true}]}'
    Q: {
        "heading":"Introduce date manipulation utility",
        "info": "The project needs a new utility module for date manipulation."
    }
    A: '{"pr_desc":"## Description\nIntroduce date manipulation utility\n\n## Changes Made\n- The project needs a new utility module for date manipulation.\n\n## Checklist\n- [x] I have tested these changes locally.\n- [ ] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [x] I have added unit tests for the new code (if applicable).\n- [ ] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nTo enhance the project's functionality, a new utility module for date manipulation is required.", "commit_msg":"feat: Introduce date manipulation utility module","src_code": [{"file_location": "E:/Dummy_Project/todo_app/src/utils/date_utils.py", "source_code": "from datetime import datetime\\n\\ndef get_current_date() -> str:\\n return datetime.now().strftime(\\"%Y-%m-%d\\")\\n", "to_create": true}, {"file_location": "E:/Dummy_Project/todo_app/src/main.py", "source_code": "from Todo import TodoApp\\nfrom date_utils import get_current_date\\ndef todo_main() -> None:\\n    \\"\\"\\" Main Function For ToDo App \\"\\"\\"\\napp: TodoApp = TodoApp()\\n    app.start()\\n\\nif __name__ == \\"__main__\\":\\n    todo_main()", "to_update": true}]}'
    Q: {
        "heading": "Unit Test for User input Function",
        "info": "Write unit test with pytest for user_input method "
    }
    A: '{"pr_desc": "## Description\nWrite unit test with pytest for user_input method\n\n## Changes Made\n- Unit Test for User input Function\n\n## Checklist\n- [x] I have tested these changes locally.\n- [ ] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [ ] I have added unit tests for the new code (if applicable).\n- [x] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nThese tests will verify the behavior and correctness of the user_input method under various scenarios, including valid and invalid inputs, edge cases, and error handling.", "commit_message": "test: Add unit test for user_input method using pytest", "src_code": [{"file_location": "E:/Dummy_Project/todo_app/tests/test_user_input.py", "source_code": "from user_input import user_input\\n\\ndef test_user_input():\\n # Test input 1\\n assert user_input(\\"1\\") == 1\\n # Test input 2\\n assert user_input(\\"2\\") == 2\\n # Test input 3\\n assert user_input(\\"3\\") == 3\\n # Test other input\\n assert user_input(\\"4\\") == \\"4\\"\\n # Test exception handling\\n assert user_input(\\"abc\\") == None\\n", "to_create": true}]}'
    Q: {
        "heading": "Extend support for user_input",
        "info": "Add support of user inputs to 4 and 5 in user_input method"
    }
    A: '{"pr_desc": "## Description\nAdd support of user inputs to 4 and 5 in user_input method\n\n## Changes Made\n- Extend support for user_input\n\n## Checklist\n- [ ] I have tested these changes locally.\n- [ ] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [ ] I have added unit tests for the new code (if applicable).\n- [] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nThis modification expands the functionality of the method to handle additional user inputs.", "commit_message": "feat: Extend support for user inputs 4 and 5 in user_input method", "src_code": [{"file_location": "E:/Dummy_Project/todo_app/src/user_input.py", "source_code": "def user_input():\\n user_input = input()\\n try:\\n if user_input == \\"1\\":\\n print(\\"This is 1\\")\\n return 1\\n elif user_input == \\"2\\":\\n print(\\"This is 2\\")\\n return 2\\n elif user_input == \\"3\\":\\n print(\\"This is 3\\")\\n return 3\\n elif user_input == \\"4\\":\\n print(\\"This is 4\\")\\n return 4\\n elif user_input == \\"5\\":\\n print(\\"This is 5\\")\\n return 5\\n else:\\n print(f\\"This is {user_input}\\")\\n return user_input\\n except Exception as err:\\n print(\\"Error Occurred\\")\\n", "to_update": true}]}'
    Q: {
        "heading": "date manipulation utility not required",
        "info": "remove the support of date manipulation utility"
    }
    A: '{"pr_desc": "## Description\nRemove the support of date manipulation utility\n\n## Changes Made\n- date manipulation utility not required\n\n## Checklist\n- [ ] I have tested these changes locally.\n- [ ] I have updated the documentation accordingly.\n- [x] I have ensured that my code follows the coding standards.\n- [ ] I have added unit tests for the new code (if applicable).\n- [x] I have verified that all existing tests pass successfully.\n\n## Additional Notes\nBy eliminating this functionality, the project streamlines its focus, reducing complexity and potential maintenance.", "commit_message": "refactor: Remove support for date manipulation utility", "src_code": [{"file_location": "E:/Dummy_Project/todo_app/src/utils/date_utils.py", "to_delete": true}, {"file_location": "E:/Dummy_Project/todo_app/src/main.py", "source_code": "from Todo import TodoApp\\n\\ndef todo_main() -> None:\\n    \\"\\"\\" Main Function For ToDo App \\"\\"\\"\\napp: TodoApp = TodoApp()\\n    app.start()\\n\\nif __name__ == \\"__main__\\":\\n    todo_main()", "to_update": true}]}'
    """